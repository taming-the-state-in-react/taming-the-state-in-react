...
How does it work? Basically you have two choices to use the Redux DevTools. Either you can integrate it directly into your project by using its node package with npm or you can install the official browser extension. While the former comes with an implementation setup in your application, the latter can be simply installed for your browser without changing your implementation.
